...
# Entrada ###########################################################################################################
# A entrada consiste de diversos casos de teste. Cada caso de teste consiste uma string informando qual a situação de
#  levantamento de pernas do papagaio.

# Saída #############################################################################################################
# Para cada condição de levantamento de pernas do papagaio, imprima a linguagem que ele utilizará. Caso ele levante 
# ambas as pernas, imprima “caiu”. Quebre uma linha a cada caso de teste.
...
# Resposta #########################################################################################################
papagaio = {"esquerda":"ingles", "direita":"frances", "nenhuma":"portugues", "ambas":"caiu"}

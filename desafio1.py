...
# um dos Nazgûl (antigos reis humanos que foram corrompidos pelos poderes dos anéis de Sauron). Saruman comanda 
# a torre de Orthanc, onde cria seus servos Uruk-hai, orcs mais terríveis que os convencionais. # 
...
# seus planos, portanto, querem saber quanto de ICM há na comunicação de seus Palantír’s, para que saibam quanto 
# de magia devem empregar na comunicação.

# Entrada ###########################################################################################################
# A entrada é composta por 3 inteiros, N(0 < N < 10000), X e Y(0 < X, Y < 100), que indicam, respectivamente, a 
# distância entre os Palantír, o diâmetro do Palantír de Sauron e o diâmetro do Palantír de Saruman.

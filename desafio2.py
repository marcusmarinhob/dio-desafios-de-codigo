...
# de cachorros-quentes consumidos e o número total de participantes na competição, você deve escrever um programa 
# para determinar o número médio de cachorros-quentes consumidos pelos participantes.
...
# consumidos pelos participantes. O resultado deve ser escrito como um número racional com exatamente dois dígitos 
...
participates = int(valores[1])

mean = cachorro_quente / participates
